...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ServerSocket_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 85, 16)
    ...
    "ServerSocket\0open_dev\0\0disconnected\0"
    "dealWithCMD_signals\0cmd\0argv\0handle\0"
...
void ServerSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->open_dev((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->disconnected((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->dealWithCMD_signals((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            typedef void (ServerSocket::*_t)(const QString & , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ServerSocket::open_dev)) {
                *result = 0;
            }
        }
        {
            typedef void (ServerSocket::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ServerSocket::disconnected)) {
                *result = 1;
            }
        }
        {
            typedef void (ServerSocket::*_t)(int , const QString & , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ServerSocket::dealWithCMD_signals)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject ServerSocket::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_ServerSocket.data,
      qt_meta_data_ServerSocket,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ServerSocket.stringdata))
...
// SIGNAL 0
void ServerSocket::open_dev(const QString & _t1, int _t2)
{
...
// SIGNAL 1
void ServerSocket::disconnected(int _t1)
{
...
// SIGNAL 2
void ServerSocket::dealWithCMD_signals(int _t1, const QString & _t2, int _t3)
{
